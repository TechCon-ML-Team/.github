...
<h2 align="center">Отдел разработки TechCon</h2>

Самостоятельная ML-команда внутри [TechCon](https://techcon.ru) — компании, занимающейся цифровым обследованием зданий и сооружений. Мы проектируем, строим и сопровождаем весь технический стек: от исследований и моделей до инфраструктуры и продакшн-деплоя.
...
Собственный стек ML-инструментов для платформы цифрового обследования:

- **Распознавание паспортов** — PDF и фото оборудования в структурированные данные
- **Классификация дефектов по голосу** — полевые обходы без бумажных бланков
- **Визуальная дефектоскопия** — автоматическое выявление дефектов по фото на нейросетевых признаках
- **Поиск технических планов** — атрибутный поиск по базе объектов
...
Попробуйте наши инструменты в работе — три интерактивных стенда на одном стенде:
